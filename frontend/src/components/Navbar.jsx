  ...
  return (
    <div className="navbar">
      <div className="navbar-left">
        {isLoggedIn && (
          <Link to="/mainPage">
            <button className="navbar-btn">Main page</button>
          </Link>
        )}
        {!isAdmin && (isLoggedIn || isLoggedIn === undefined) && (
        ...
        {(isLoggedIn || isLoggedIn === undefined) && (
          <Link to="/users">
            <button className="navbar-btn">Users</button>
          </Link>
        )}
        {(isLoggedIn || isLoggedIn === undefined) && isAdmin && (
          <Link to="/reports">
            <button className="navbar-btn">Reports</button>
          </Link>
        )}
      </div>
      ...
      <div className="navbar-right">
        {isLoggedIn && !isAdmin && (
          <Link to="/notification">
            <button className="navbar-btn">Notifications</button>
          </Link>
        )}
        {!isLoggedIn && (
          <Link to="/login">
